...
define(["avalon", "text!./avalon.tooltip.html", "text!./avalon.tooltip.css", "avalon.position"], function(avalon, tmpl, css) {
    ...
    var widget = avalon.ui.tooltip = function(element, data, vmodels) {
        ...
        var vmodel = avalon.define(data.tooltipId, function(vm) {
            ...
            //@method show(elem) 显示tooltip，相对于elem定位，elem为元素或者event事件对象，如果elem为空，则不改变位置
            vm.show = function(elem) {
                ...
                if(vmodel.animated && !document.attachEvent) {
            ...
            vm.$show = function(e) {
                ...
                if(!inited) {
                    ...
                    avalon(tar).bind(vmodel.event != "focus" ? "mouseleave" : "blur", function() {
                        clearTimeout(hideTimer)
    ...
    widget.defaults = {
        ...
        "hiddenDelay": 16,    //@param tooltip自动隐藏时间，默认16ms
